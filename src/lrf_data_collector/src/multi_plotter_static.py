...
class PlotOdomOnMap:
    def __init__(self):
        ...
        self.csv_files = {
            'Dijkstra': ['data/realworld_data/static/odom/dijkstra_1.csv',
                         'data/realworld_data/static/odom/dijkstra_2.csv',
                         'data/realworld_data/static/odom/dijkstra_3.csv'],
            'A*': ['data/realworld_data/static/odom/a_star_1.csv',
                   'data/realworld_data/static/odom/a_star_2.csv',
                   'data/realworld_data/static/odom/a_star_3.csv'],
            'D* Lite': ['data/realworld_data/static/odom/d_star_lite_1.csv',
                        'data/realworld_data/static/odom/d_star_lite_2.csv',
                        'data/realworld_data/static/odom/d_star_lite_3.csv'],
            'RRT': ['data/realworld_data/static/odom/rrt_1.csv',
                    'data/realworld_data/static/odom/rrt_2.csv',
                    'data/realworld_data/static/odom/rrt_3.csv'],
            'RRT*':['data/realworld_data/static/odom/rrt_star_1.csv',
                    'data/realworld_data/static/odom/rrt_star_2.csv',
                    'data/realworld_data/static/odom/rrt_star_3.csv'],
            'Informed RRT':  ['data/realworld_data/static/odom/informed_rrt_1.csv',
                              'data/realworld_data/static/odom/informed_rrt_2.csv',
                              'data/realworld_data/static/odom/informed_rrt_3.csv']
        }
